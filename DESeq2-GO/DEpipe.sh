...
MATRIX_PATH="/tscc/nfs/home/rlancione/myprojects/Heart_FNIH/DESeq/RMatrices/"
...
OUTDIR='/tscc/nfs/home/rlancione/myprojects/Heart_FNIH/DESeq/Results_R/Res_n10/'
...
Rscript $Report -rp $OUTDIR -mp $MATRIX_PATH -ap $PADJ_CUTOFF -lfc $LOG2FC_CUTOFF -org "human" \
	        -pn $PROJ -sp $SEU_OBJ -ct $CT_COL -a $ASSAY -run_cp "FALSE"
